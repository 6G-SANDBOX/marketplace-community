...
# ONEAPP_UERANSIM_UE_HNET_PUBKEY="${ONEAPP_UERANSIMUE_HNET_PUBKEY:-5a8d38864820197c3394b92613b20b91633cbd897119273bf8e4a6f4eec0a650}"
# ONEAPP_UERANSIM_UE_HNET_PUBKEY_ID="${ONEAPP_UERANSIMUE_HNET_PUBKEY_ID:-1}"
# ONEAPP_UERANSIM_UE_SUCI_PROT="${ONEAPP_UERANSIMUE_SUCI_PROT:-0}"
